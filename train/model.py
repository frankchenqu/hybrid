...
class Predictor(nn.Module):
    ...
    def forward(self, compound1, compound2, adj, protein1, protein2, n_layers):
        ...
        protein1_c, compound1_p = self.decoder(protein1,
                                               compound1)  # protein1_c:(1,1,64)    # compound1_p:(1,1,64) 交互信息，decoder为MINN中的Interformer模块,都使用了mean
